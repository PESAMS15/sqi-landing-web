...
const Main2 = () => {
  return (
    <div className='p-5 gj bg-primary text-white'>
        <div className='container-md '>
           <div className="nj">
                <h3>SCICT AT A GLANCE</h3>
                <p className='w-50 hh'><p>SQI College of ICT offers both National Diploma and Professional Certificate programmes.</p>
                <p>
            ...
            <button className="le">Learn more</button>
           </div>
        </div>
    </div>
  )
